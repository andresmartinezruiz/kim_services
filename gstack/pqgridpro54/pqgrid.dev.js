        ...
        if (o && o.length) {
            for (var v = 0, m = o.length; m > v; v++) {
                ...
                if (d) {
                    ...
                    if (null == x) continue;
                    if (r = h ? f() : "", c) {
                        var I = w.pq_disabled_group ? 'disabled="disabled" ' : "";
                        e = w[a], n != e && (null != n && p.push("</optgroup>"), p.push('<optgroup label="', e, '" ', I, " >"), n = e)
                    }
                    if (l == s) p.push("<option ", C, y, r, ">", x, "</option>");
                    else {
                        var b = w[l];
                        p.push("<option ", C, y, r, ' value="', x, '">', b, "</option>")
                    }
...
function(t) {
    ...
    n._isValidCell = function(t) {
        ...
        else var b = t.extend({}, C ? p : f, x.validation),
            _ = b.css,
            q = b.cls,
            R = b.icon,
            D = b.style;
            ...
            if (d) {
                ...
                if (l) {
                    ...
                    T = r.getCell(P), r.scrollCell(P, function() {
                        n.onScrollCell(T, I, R, q, _, D), r.focus(P)
                    })
                }
                this.onScrollCell(T, I, R, q, _, D)
            }
            return x
        }
        if (l) {
...
function(t) {
    ...
    a.refreshCM = function(t, e) {
    ...
    }, a._onClickCont = function(t) {}, a._onClickRow = function(e) {
        var n = this,
            r = t(e.currentTarget),
        ...
        if (null != d) {
            ...
            return I === !1 ? !1 : (this._trigger("cellSave", a, x), !0)
        }
        ...
        if (_ = t.addList = t.addList || [], t.updateList = t.updateList || [], t.deleteList = t.deleteList || [], _.length && _[0].rowData) throw "rd in addList";
        ...
        for (!l && (l = a.data = []), e = 0, n = q.length; n > e; e++) {
            var T, k = q[e],
                ...
                $ = k.rowIndx,
                F = k.oldRow;
            if (null == P && (P = x), !F) throw "oldRow required while update";
            if (!P || i.editable === !0 || r.isEditableRow({
                    rowIndx: $,
                    rowData: S
                }) !== !1) {
                if (T = this._digestNewRow(E, F, $, S, "update", P, u, f, C), T === !1) return !1;
                T && M.push(k)
            }
        }
        for (e = 0, n = _.length; n > e; e++) {
            var S, F, k = _[e],
                E = k.newRow,
                P = k.checkEditable,
                $ = k.rowIndx;
            if (null == P && (P = y), s.forEach(function(t) {
                    var e = t.dataIndx;
                    E[e] = E[e]
                }), T = this._digestNewRow(E, F, $, S, "add", P, u, f, C), T === !1) return !1;
            T && D.push(k)
        }
        return _ = t.addList = D, q = t.updateList = M, _.length || q.length || R.length ? (v && (m.increment(), m.push(t)), r._digestUpdate(q, w, g), _.length && (r._digestAdd(_, w, g, l, d, h, b), I.addRowIndx()), R.length && (r._digestDelete(R, w, g, l, d, h, b), I.addRowIndx()), r._trigger("change", null, t), !0) : "edit" == C ? null : !1
        ...
        if (void 0 === w && "function" == typeof d.geditor && (w = d.geditor.call(x, m)), w !== !1) {
            ...
            var M, T = I.type,
                k = null == n.select ? I.select : n.select,
                E = I.init,
                S = I.valueIndx,
                P = I.dataMap,
                $ = I.mapIndices,
                ...
                N = O,
                B = O;
            if (m.cls = A, m.attr = V, "function" == typeof T && (M = T.call(x, m), M && (T = M)), C._type = T, "checkbox" == T) {
                var z = I.subtype,
                    U = v ? "checked='checked'" : "";
                M = "<input " + U + " class='" + H + "' " + V + " " + B + " type=checkbox name='" + g + "' />", D.html(M);
                ...
                if ("textarea" == T) M = "<textarea class='" + H + "' " + V + " " + N + " name='" + g + "' ></textarea>";
                else if ("select" == T) {
                    var W = I.options || [];
                    W.constructor !== Array && (W = r.callFn(W, m));
                    var G = [V, " class='", H, "' ", N, " name='", g, "'"].join("");
                    M = i.select({
                        options: W,
                        attr: G,
                        prepend: I.prepend,
                ...
                } else M = "<input class='" + H + "' " + V + " " + N + " type=text name='" + g + "' />";
                t(M).appendTo(D).val("select" == T && null != S && ($[S] || this.columns[S]) ? $[S] ? u[$[S]] : u[S] : v)
            } else T && "contenteditable" != T || (M = "<div contenteditable='true' tabindx='0' " + O + " " + V + " class='" + H + "'></div>", D.html(M), D.children().html(v), b = !0);
                ...
                if (C && C.length)
                    if ("select" == x && null != h)
                        if (p[h] || this.columns[h]) {
                            ...
                            var I = u.dataMap;
                            if (I) {
                                var b = C.find("option:selected").data("map");
                                if (b)
    ...
    e.prototype = {
        bodyKeyPressDown: function(e) {
            ...
            var y, C, I = l.normalize(h),
                ...
                _ = I,
                q = !0;
            if (null != n && null != i && null != I.rowData) {
                if (u.ismergedCell(n, i) && (_ = u.getRootCellO(n, i), I = _, r = I.rowIndxPage, n = I.rowIndx, i = I.colIndx, x != w.PAGE_UP && x != w.PAGE_DOWN && x != w.HOME && x != w.END || (y = u.getData(n, i, "proxy_cell")) && (C = y.rowIndx - s, b[C].pq_hidden || (r = C, n = r + s)), f[i].hidden && (i = l.getNextVisibleCI(i))), 0 == l._trigger("beforeCellKeyDown", e, _)) return !1;
                ...
                for (var v = 0; d > v; v++) {
                    ...
                    if (!w) {
                        var x = m.width,
                            ...
                            I = I ? this.numericVal(I, p) : h;
                        if (C > I && (I = C), void 0 != x) {
                            var b, _ = 0;
                            !i && y ? (e.percentColumn = !0, m.resizable = !1, m._percent = !0, b = this.numericVal(x, p) - o, _ = Math.floor(b), g += b - _, g >= 1 && (_ += 1, g -= 1)) : x && (_ = 1 * x), C > _ ? _ = C : _ > I && (_ = I), m._width = _
                        } else m._width = C;
                        y || (m.width = m._width), m._minWidth = C, m._maxWidth = i ? 1e3 : I
                    }
                }
        ...
        renderCell: function(t) {
            ...
            if (u) {
                ...
                var w, x, y = u[g],
                    ...
                    I = C ? this.format(y, C, f) : y;
                if (t.dataIndx = g, t.cellData = y, t.formatVal = I, (i = h.render) && (w = o.callFn(i, t), w && "string" != typeof w && ((e = w.attr) && a.push(e), (r = w.cls) && c.push(r), (n = w.style) && l.push(n), w = w.text)), null == w && (i = h._render) && (w = i.call(o, t)), w && "string" != typeof w && ((e = w.attr) && a.push(e), (r = w.cls) && c.push(r), (n = w.style) && l.push(n), w = w.text), null == w && (w = I || y), s) return [w, n];
                var b = u.pq_cellcls;
                if (b) {
                    var _ = b[g];
                    _ && c.push(_)
    ...
    e.cHeaderSearch = function(t) {}, e.cHeaderSearch.prototype = {
        ...
        onCreateHeader: function() {
            var t = this,
                ...
                r = n.filterModel;
            if (r.header)
                for (var i = t.colDef, o = 0, a = i.length; a > o; o++) {
                    var l = i[o],
                        s = l.column,
                        d = s.filter;
                    d && t.postRenderCell(s)
                }
        },
                ...
                if (e.refreshComplete) {
                    for (e.refreshComplete = !1, s = i; o >= s; s++)
                        if (d = v[s], d && !d.pq_hidden) {
                            ...
                            var y = x.parent(),
                                C = u.getHeightCell(s),
                                I = n.dims.wdContLeft + 5,
                                b = "position:absolute;left:0;top:" + C + "px;padding:5px;width:100%;overflow:hidden;padding-left:" + I + "px;";
                            if (y.length) {
                                if (!document.body.contains(y[0])) throw "incorrectly detached detail";
                                y.css({
                                    top: C
                                })
                            } else y = t("<div role='gridcell' id='" + e.getId(s) + "' class='" + h + "' style='" + b + "'></div>").append(x), t(u.getRow(s, p > s ? "tr" : "right")).append(y), e.onResize(e, y);
        ...
        addBlock: function(t, e) {
            if (t && this.addUnique(this.ranges, t)) {
                ...
                if (f) {
                    ...
                    var p, g, v, m, w, x, y, C, I, b, _ = h(r, i),
                        q = h(o, a);
                    if (f = u.getCellXY(r, i), w = f[0] - 1, x = f[1] - 1, f = u.getCellCoords(o, a), y = f[2], C = f[3], I = C - x, b = y - w, _ == q ? this.addLayer(w, x, I, b, s, _) : (p = h(r, a), g = h(o, i), v = _[0].offsetWidth, m = _[0].offsetHeight, g == _ ? (this.addLayer(w, x, I, v - w, s, _, "border-right:0;"), this.addLayer(0, x, I, y, s, q, "border-left:0;")) : _ == p ? (this.addLayer(w, x, m - x, b, s, _, "border-bottom:0;"), this.addLayer(w, 0, C, b, s, q, "border-top:0;")) : (this.addLayer(w, x, m - x, v - w, s, _, "border-right:0;border-bottom:0"), this.addLayer(0, x, m - x, y, s, p, "border-left:0;border-bottom:0"), this.addLayer(w, 0, C, v - w, s, g, "border-right:0;border-top:0"), this.addLayer(0, 0, C, y, s, q, "border-left:0;border-top:0"))), b = n.options.numberCell.outerWidth || 0, this.addLayer(0, x, I, b, d, u.$clt, ""), this.addLayer(0, x, I, b, d, u.$cleft, ""), 0 != n.options.showHeader) {
                        u = n.iRenderHead, f = u.getCellXY(0, i), w = f[0], x = f[1], f = u.getCellCoords(n.headerCells.length - 1, a), y = f[2], C = f[3], I = C - x, b = y - w;
                        var R = u.$cright;
                        this.addLayer(w, x, I, b, c, R, ""), R = u.$cleft, this.addLayer(w, x, I, b, c, R, "")
                    }
                }
            }
        },
    ...
    r.prototype = t.extend({
        ...
        _copyArea: function(t, e, n, r, i, o, a, l, s, d, c) {
            var u, h, f, p, g, v, m, w, x = this.that,
                ...
                _ = x.riOffset,
                q = x.iRenderB;
            for (g = n; r >= g; g++) m = i[g], w = m.dataType, b[g] = !w || "string" == w || "html" == w;
            for (p = t; e >= p; p++) {
                var R = [],
                    D = l[p],
                    M = {},
                ...
                for (g = n; r >= g; g++) m = i[g], v = m.dataIndx, m.copy !== !1 && (u = D[v], d && (h = y(D, m, I, p, g), h === u && (k.colIndx = g, k.column = m, k.dataIndx = v, h = C(k, c, q)[0], b[g] && /(\r|\n)/.test(h) && (h = this.newLine(h))), R.push(h)), s && void 0 !== u && (M[v] = void 0, T[v] = u));
                s && a.push({
                    rowIndx: p,
                    rowData: D,
                    oldRow: T,
        ...
        _create: function() {
            ...
            for (h.addClass("pq-toolbar"); p > f; f++) {
                var g, v, m, w = u[f],
                    ...
                    E = b ? "<label " + M + ">" + b : "",
                    S = b ? "</label>" : "",
                    P = b && "button" != x && "file" != x ? [R, k] : [R, k, M],
                    P = P.join(" ");
                if (w.options = I, "textbox" == x) v = t([E, "<input type='text' " + P + ">", S].join(""));
                else if ("textarea" == x) v = t([E, "<textarea " + P + "></textarea>", S].join(""));
                else if ("select" == x) "function" == typeof I && (I = I.call(o, {
                    colModel: d
                })), I = I || [], g = e.select({
                    options: I,
                    attr: P,
                ...
                else if ("file" == x) v = t(["<label class='btn btn-default' " + P + ">", b || "File", "<input type='file' style='display:none;'>", "</label>"].join(""));
                else if ("checkbox" == x) v = t([b ? "<label " + M + ">" : "", "<input type='checkbox' ", y ? "checked='checked' " : "", P, ">", b ? b + "</label>" : ""].join(""));
                else if ("separator" == x) v = t("<span class='pq-separator' " + [k, M].join(" ") + "></span>");
                else if ("button" == x) {
                    var $ = "";
                    s && ($ = C ? "<span class='glyphicon " + C + "'></span>" : ""), v = t("<button type='button' " + P + ">" + $ + b + "</button>"), t.extend(I, {
                        label: b ? b : !1,
                        icon: C,
                        icons: {
                            primary: s ? "" : C
                ...
                v.appendTo(h), m = this.getInner(v, b, x), "checkbox" !== x && void 0 !== y && m.val(y);
                for (var F = 0, A = _.length; A > F; F++) {
                    r = _[F];
                    var H = {};
                    "function" == typeof r ? H[a[x]] = r : H = r;
                    for (n in H) pq.fakeEvent(m, n, c), m.on(n, this._onEvent(o, H[n], w))
                }
            }
        }
                    ...
                    if (m.rowData == o) {
                        ...
                        for (var l in u) {
                            ...
                            if (w.hasOwnProperty(l) && I === C) {
                                ...
                                n.addClass(b), w.hasOwnProperty(l) || (w[l] = o[l])
                            }
                        }
        ...
        paste: function(e) {
            ...
            if (h.on && 0 != o.length && 0 != s) {
                ...
                var m, w, x, y, C = h.type,
                    I = r ? n.Range(r) : n.Selection(),
                    b = I.address(),
                    _ = b.length ? b : n.iRows.toRange().address(),
                    q = _[0],
                    R = {
                        rows: l,
                        areas: [q]
                ...
                for (v = 0; S > v; v++) {
                    ...
                    for (E = k, j = 0; E > j; j++) {
                        ...
                        var G = j + w,
                            ...
                            Q = B[U],
                            X = K.dataIndx;
                        K.copy !== !1 ? (U++, N[X] = Q, O && (O[X] = u(L, K))) : (W++, "extend" == T && g > E + w && E++)
                    }
                    0 == t.isEmptyObject(N) && (null == L ? (p = !0, $.push({
                        newRow: N,
                        rowIndx: V
                    })) : F.push({
                        newRow: N,
        ...
        compileSorter: function(t, e) {
            ...
            for (var g = 0; p > g; g++) {
                var v = t[g],
                    ...
                    C = w.sortType,
                    C = pq.getFn(C),
                    I = w.dataType || v.dataType || "string",
                    I = "string" == I && f ? "stringi" : I,
                    b = h && "date" == I,
                    _ = b ? c + m : m;
                ...
                }(C, r.sort_sortType) : "integer" == I ? l[g] = r.sort_number : "float" == I ? l[g] = r.sort_number : "function" == typeof I ? l[g] = function(t, e) {
                    return function(n, r, i, o) {
                        return e(n, r, i, o, t)
                    }
                }(I, r.sort_dataType) : "date" == I ? l[g] = r["sort_date" + (b ? "_fast" : "")] : "bool" == I ? l[g] = r.sort_bool : "stringi" == I ? l[g] = r.sort_locale : l[g] = r.sort_string, b && n.useCache(e, I, m, _)
            }
        ...
        init: function() {
            for (var t = this.that, n = this.findNextVisibleColumn, r = this.findNextVisibleRow, i = this.calcVisibleColumns, o = t.colModel, a = t.options.mergeCells || [], l = t.get_p_data(), s = [], d = [], c = 0, u = a.length; u > c; c++) {
                var h, f, p = a[c],
                    ...
                    C = p.rc,
                    I = p.cc;
                if (y && m && (y.hidden && (x = n(o, w, I)), h = i(o, w, w + I), m.pq_hidden && (v = r(l, g, C)), f = e(l, g, g + C), !(1 > f || 1 > h))) {
                    s.push({
                        r1: g,
                        c1: w,
                        rc: C,
                    ...
                    for (var b = {
                        ...
                        d[_] = d[_] || [];
                        for (var q = w; w + I > q; q++) _ == v && q == x || (d[_][q] = b)
                    }
                }
            }
    ...
    i.beforeTrigger = function(t, e) {
        ...
        initmerge: function() {
            for (var t, e, n, r, i, o, a, l, s = this.that, d = s.options, c = d.groupModel, u = c.dataIndx, h = s.colIndxs, f = c.merge, p = c.summaryInTitleRow, g = c.titleInFirstCol, v = this.tree, m = s.riOffset, w = s.colModel.length, x = [], y = s.pdata, C = 0; C < v.length; C++) {
                t = v[C], n = h[u[C]];
                for (var I = 0, b = t.length; b > I && (e = t[I], r = e.rip, null != r); I++) f ? (i = e.rip2, o = i - r, a = r + m, x.push({
                    r1: a,
                    rc: o,
                    c1: n,
                    cc: 1
        ...
        renderCell: function(t, e) {
            return function(n) {
                var r, i, o, a, l, s, d, c = n.rowData,
                    ...
                    y = x * h,
                    C = y + 1 * h,
                    I = ["pq-group-title-cell"],
                    b = ["text-indent:", m ? y : C, "px;"],
                    _ = n.formatVal || n.cellData;
                if (p) {
                    var q = u.callFn(p, n);
                    null != q && ("string" != typeof q ? (q.iconCls && (w = q.iconCls), null != q.text && (_ = q.text), l = q.attr, I.push(q.cls), b.push(q.style)) : _ = q)
                }
                return n.Export ? t.exportCell(_, x) : (v && (s = t.renderCB(v, c, e.cbId), s && (d = s[0], s[1] && I.push(s[1]))), m && (o = c.pq_close ? g[1] : g[0], i = "<span class='pq-group-icon ui-icon " + o + "'></span>"), w && (a = "<span class='pq-tree-icon ui-icon " + w + "'></span>"), r = d && (f.useLabel || e.useLabel), {
                    cls: I.join(" "),
                    attr: l,
                    style: b.join(""),
    ...
    n.prototype = {
        ...
        importS: function(t, n, r, i, o) {
            var a, l, s, d, c, u, h, f = t.mergeCells,
                ...
                y = w.length,
                C = 0,
                I = v.options.colModel,
                b = 0,
                _ = I && I.length,
                q = e.cFormulas.shiftRC();
            for (null != o && (b = o + 1, u = w[o], w = w.slice(b), x -= b, x = x > 0 ? x : 0), C = 0, y = w.length; y > C; C++) a = w[C], l = a.indx || C, s = {}, l != C && this.fillRows(g, l, !0), a.cells.forEach(function(t, e) {
                d = t.indx || e, c = i && _ && I[d] ? I[d].dataIndx : d, s[c] = t.value, p.copyStyle(s, c, t), t.format && p.copyFormat(s, c, t.format), h = t.formula, h && p.copyFormula(s, c, b ? q(h, 0, -b) : h), d >= m && (m = d + 1)
...
function(t) {
    pq.excelImport = {
        ...
        getWorkSheet: function(t, e, n, r) {
            for (var i, o, a, l, s, d, c, u, h, f, p, g, v, m, w, x, y, C = this, I = [], b = 0, _ = pq.toNumber, q = this.getFormula(C), R = pq.isEmpty, D = pq.formulas, M = pq.isDateFormat, T = C.getMergeCells(t), k = e.match(/<row.*?<\/row>/g) || [], E = 0, S = k.length; S > E; E++) {
                d = {
                    cells: []
                }, w = k[E], v = C.attr(w), y = v.r, x = y ? y - 1 : E, x !== E && (d.indx = x), v.hidden && (d.hidden = !0), c = w.match(/(<c[^<]*?\/>|<c.*?<\/c>)/g) || [];
                for (var P = 0, $ = c.length; $ > P; P++) {
                    if (o = c[P], m = C.attr(o), u = m.t, g = C.match(o, /<c.*?>(.*?)(<\/c>)?$/, 1), s = {}, "inlineStr" == u ? f = g.match(/<t><!\[CDATA\[(.*?)\]\]><\/t>/)[1] : (f = C.match(g, /<v>(.*?)<\/v>/, 1) || void 0, null != f && (f = "s" == u ? n[f] : "str" == u ? pq.unescapeXml(f) : "b" == u ? "1" == f : D.VALUE(f))), p = m.r, p ? (p = p.replace(/\d+/, ""), p = _(p)) : p = P, b = b > p ? b : p, void 0 !== f && (s.value = f), p !== P && (s.indx = p), a = q(g, x, p), a && (s.formula = pq.unescapeXml(a)), h = m.s, h && (h = this.getStyle(h))) {
                        for (i in h) s[i] = h[i];
            ...
            var F = {
                ...
                A = C.getCols(t),
                H = C.getFrozen(t);
            return T.length && (F.mergeCells = T), A.length && (F.columns = A), H.r && (F.frozenRows = H.r), H.c && (F.frozenCols = H.c), F
        },
        Import: function(t, e) {
            var n, r, i, o = this,
                a = t.file,
...
function(t) {
    ...
    r.prototype = t.extend({
        ...
        getCSVContent: function(t, e, n, r, i, o, a, l, s, d, c, u, h) {
            var f, p, g, v, m, w, x, y, C, I, b, _ = this,
                q = t.separator || ",",
                R = [];
            for (b = h ? _.getCsvHeader(r, i, e, q) : [], v = 0; a > v; v++)
                if (x = o[v], !x.pq_hidden) {
                    ...
                    for (var m = 0; n > m; m++)
                        if (I = e[m], !I.hidden && I.copy !== !1) {
                            p = null, f = null, d.ismergedCell(y, m) ? (f = d.isRootCell(y, m)) ? (p = d.getRootCellO(y, m), p.Export = !0, g = _.getRenderVal(p, c, u)[0]) : g = "" : (w.colIndx = m, w.column = I, w.dataIndx = I.dataIndx, g = _.getRenderVal(w, c, u)[0]);
                            var D = (null == g ? "" : g) + "";
        ...
        Export: function(t) {
            ...
            if ("xlsx" == I) {
                var b = n.getWorkbook(p, g, c, u, w, x, a, l, d, y, s, C, t.sheetName);
                return r._trigger("workbookReady", null, {
                    workbook: b
                }) === !1 ? b : t.workbook ? b : (t.workbook = b, pq.excel.exportWb(t))
            }
            return "json" == I ? t.data = n.getJsonContent(t, w) : "csv" == I ? t.data = n.getCSVContent(t, h, f, c, u, w, x, a, l, d, y, s, C) : t.data = n.getHtmlContent(t, h, f, c, u, w, x, a, l, d, y, s, C), e = e || n.postRequest(t), r._trigger("exportData", null, t), e
        },
        ...
        getHtmlBody: function(t, e, n, r, i, o, a, l, s) {
            var d, c, u, h, f, p, g, v, m, w, x, y, C, I, b = this,
                _ = [];
            for (d = 0; r > d; d++)
                    ...
                    for (w = i ? d + o : d, x = w - o, v = {
                        ...
                        if (u = t[c], !u.hidden && u.copy !== !1) {
                            if (h = null, f = null, C = "", a.ismergedCell(w, c)) {
                                ...
                                h = a.getRootCellO(w, c), h.Export = !0, p = b.getRenderVal(h, l, s), y = p[0], g = p[1], C = "rowspan=" + f.rowspan + " colspan=" + f.colspan + " "
                            } else v.colIndx = c, v.column = u, v.dataIndx = u.dataIndx, p = b.getRenderVal(v, l, s), y = p[0], g = p[1];
                            I = u.align, C += I ? "align=" + I : "", y = null == y ? "" : y, y = pq.newLine(y), _.push("<td ", C, g ? ' style="' + g + '"' : "", ">", y, "</td>")
                        }
                    _.push("</tr>")
                }
            return _.join("")
        ...
        getXlsBody: function(n, r, i, o, a, l, s, d, c, u) {
            var h, f, p, g, v, m, w, x, y, C, I, b, _, q, R, D, M, T, k, E = this,
                S = E.that,
                P = [],
                $ = e.cFormulas.shiftRC(S);
            for (f = 0; o > f; f++) {
                for (b = i[f], I = [], _ = a ? f + l : f, q = _ - l, x = {
                        rowIndx: _,
                        rowIndxPage: q,
                        rowData: b,
                        Export: !0
                    }, p = 0; r > p; p++) w = n[p], R = w.dataIndx, T = b.pq_cellattr, m = b[R], g = m, v = S.getFormula(b, R), h = !1, s.ismergedCell(_, p) && (s.isRootCell(_, p, "o") || (h = !0)), h || v || (x.colIndx = p, x.column = w, x.dataIndx = R, y = E.getRenderVal(x, d, c), g = y[0], C = y[1]), k = E.getCellFormat(b, R) || w.format, M = {}, "string" == typeof k && (pq.isDateFormat(k) ? (g !== m && t.datepicker.formatDate(k, new Date(m)) === g && (g = m), k = pq.juiToExcel(k)) : (g !== m && pq.formatNumber(m, k) === g && (g = m), k = pq.numToExcel(k)), M.format = k), void 0 !== g && (M.value = g), T && (T = T[R]) && (T = T.style) && E.copyStyle(M, T), C && E.copyStyle(M, C), v && (u && (v = $(v, 0, u)), M.formula = v), pq.isEmpty(M) || (M.dataIndx = R, I.length !== p && (M.indx = p), I.push(M));
                D = {}, I.length && (D.cells = I), b.pq_hidden && (D.hidden = !0), pq.isEmpty(D) || (P.length !== f && (D.indx = f), P.push(D))
            }
            return P
        },
        ...
        getWorkbook: function(t, e, n, r, i, o, a, l, s, d, c, u, h) {
            var f, p = this,
                ...
                b = p.getXlsBody(t, e, i, o, a, l, s, d, c, x),
                _ = {
                    columns: g,
                    rows: C.concat(b)
                };
            return I.length && (_.mergeCells = I), (f = C.length) && (_.headerRows = f), y && (_.frozenRows = y), w && (_.frozenCols = w), (h || (h = m.title)) && (_.name = h), {
                sheets: [_]
            }
        },
...
var pqEx = pq.excel = {
    ...
    getBody: function(t) {
        var e, n, r, i, o, a, l, s, d, c, u, h, f, p, g, v, m, w, x, y, C, I, b, _, q, R, D = this,
            M = pq.formulas,
            T = [],
            k = t.length;
        for (e = 0; k > e; e++) {
            for (f = t[e], u = f.cells, _ = u.length, q = f.hidden ? 'hidden="1"' : "", r = (f.indx || e) + 1, o = 'r="' + r + '"', T.push("<row " + q + " " + o + ">"), n = 0; _ > n; n++) c = u[n], h = c.value, i = c.indx || n, a = "", l = "", o = i === n ? "" : 'r="' + pq.toLetter(i) + r + '"', R = c.format, p = c.bgColor, g = c.color, v = c.font, m = c.fontSize, C = c.bold, I = c.italic, b = c.underline, w = c.align, x = c.wrap, y = c.valign, d = c.formula, d = d ? "<f>" + pq.escapeXml(d) + "</f>" : "", null == h ? s = "<v></v>" : h == parseFloat(h) ? s = "<v>" + h + "</v>" : R && M.isDate(h) ? s = "<v>" + M.VALUE(h) + "</v>" : "boolean" == typeof h ? (s = "<v>" + (h ? "1" : "0") + "</v>", a = 't="b"') : (a = 't="inlineStr"', s = "<is><t><![CDATA[" + h + "]]></t></is>"), (R || p || g || m || w || y || x || C || I || b) && (l = 's="' + D.getStyleIndx(R, p, g, v, m, w, y, x, C, I, b) + '"'), T.push("<c " + a + " " + o + " " + l + ">" + d + s + "</c>");
            T.push("</row>")
        }
        return T.join("")
    },
    ...
    getStyle: function() {
        ...
        if (w) {
            delete w.length;
            for (m in w) I.push('<numFmt numFmtId="' + w[m] + '" formatCode="' + m + '"/>');
            delete this.formats
        }
        if (x) {
            delete x.length;
            for (m in x) b.push('<fill><patternFill patternType="solid"><fgColor rgb="' + this.getColor(m) + '"/></patternFill></fill>');
            delete this.fills
        }
        if (y) {
            delete y.length;
        ...
        return I = I.join("\n"), q = q.join("\n"), b = b.join("\n"), _ = _.join(""), ['<?xml version="1.0" encoding="UTF-8" standalone="yes"?>', '<styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">', "<numFmts>", I, "</numFmts>", "<fonts>", '<font><sz val="11"/><color theme="1"/><name val="Calibri"/><family val="2"/><scheme val="minor"/></font>', _, "</fonts>", '<fills><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill>', b, "</fills>", '<borders count="1"><border><left/><right/><top/><bottom/><diagonal/></border></borders>', '<cellStyleXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0"/>', "</cellStyleXfs>", "<cellXfs>", q, "</cellXfs>", '<cellStyles count="1"><cellStyle name="Normal" xfId="0" builtinId="0"/></cellStyles>', '<dxfs count="0"/><tableStyles count="0" defaultTableStyle="TableStyleMedium9" defaultPivotStyle="PivotStyleLight16"/>', "</styleSheet>"].join("")
    },
    importXl: function() {
        ...
        $.extend(cFormulas, {
            ...
            onDataReadyDone: function() {
                var t, e = this,
                    ...
                    o = function(n, o, a) {
                        var l, s, d;
                        for (s in a) l = a[s], t = !0, "string" == typeof l ? e.save(n, s, e.check(l), o, i[s]) : l.ri != o && (d = o - l.riO,
                            l.ri = o, l.fn = r(l.fnOrig, l.ci - l.ciO, d))
                    },
                    a = function(t) {
                        t = t || [];
            ...
            r = {
                ...
                transformData: function(t, e, n, r) {
                    ...
                    return t.forEach(function(t) {
                        ...
                        }) : ((!a || o > f && m > f) && (a = {}, i = !0), m > f && (u[y] = a[y] = C), v && x - 2 >= f && f >= m - 1 && (t.pq_children.length > 1 && (g.aggr = {}), e.forEach(function(e) {
                            l = h.slice(0, p + 1), l.push("aggr"), l.push(e), a[l.join("_")] = t[e]
                        }))), o = f, i && (s.push(a), r.forEach(function(t) {
                            void 0 === a[t] && (a[t] = u[t])
                        }), i = !1)
                    }), c.setDMData(p.data), p.data = d.pdata = s, w
                },
    ...
    function(t) {
        ...
        e.cRender = function() {
            ...
            refresh: function(t) {
                ...
                for (var y in o) {
                    var c = y.split(","),
                        ...
                        I = 1 * c[1],
                        b = c[2];
                    e.renderView(C, C, I, I, b)
                }
                var _ = h != e.initH || p != e.finalH,
                    q = _ && null != e.initH;
                (f != e.finalV || u != e.initV || _) && (r && _ && e.createColDefs(h, p), e.initV = u, e.finalV = f, e.initH = h, e.finalH = p, r ? n._trigger("refresh", null, {
                    source: t.source,
                    hChanged: q
            ...
            setCellDims: function(t) {
                for (var e, n, r = this, i = r.initV, o = r.iMerge, a = r._m(), l = r.colModel, s = r.numColWd, d = r.finalV, c = r.jump, u = (r.mcLaid, r.data), h = r.riOffset, f = r.initH, p = r.finalH, g = r.freezeCols, v = r.freezeRows, m = (r.leftArr, r.leftWdArr, 0); d >= m; m++) {
                    m = c(i, v, m);
                    var w, x = r.get$Row(m),
                        y = r.getHeightR(m),
                        C = r.getTop(m),
                    ...
                    if (I && !I.pq_hidden) {
                        r.setRowDims(x, y, C);
                        for (var _ = s ? -1 : 0; p >= _; _++) _ = c(f, g, _), (0 > _ || !l[_].hidden) && (a && (e = o.ismergedCell(m, _)) || (w = r.getCell(m, _), w && (n = w.style, n.height = (-1 == _ ? y : b) + "px", t || (n.width = r.getWidthCell(_) + "px", n.left = r.getLeft(_) + "px"))))
                    }
                }
                var q = r.getMergeCells(),
                    R = q.length;
                for (m = 0; R > m; m++) {
                    w = q[m];
                    var D = r.getCellIndx(w);
                    if (D) {
                        var M = D[0],
                            T = D[1],
                            e = o.getRootCell(M + h, T),
                            k = e.v_ri - h;
                        x = r.get$Row(k), y = r.getHeightR(k), b = r.getHeightCellM(M, e.o_rc), C = r.getTop(k), r.setRowDims(x, y, C), n = w.style, n.height = b + "px", t || (n.width = r.getWidthCellM(T, e.o_cc) + "px", n.left = r.getLeft(T) + "px")
                    }
                }
            },
            ...
            setColWdArr: function(e, n) {
                var r, i, o, a, l, s, d, c, u = n,
                    ...
                    C = h.isSum(),
                    I = y || C,
                    b = h.isHead() ? h.that.headerCells.length - 1 : h.finalV;
                if (b >= 0)
                    for (; u >= e; u--)
                        if (i = p[u], !i.hidden && -1 == (i.width + "").indexOf("%") && (s = I ? i.width : i._minWidth)) {
                            for (r = 0; b >= r; r++)
            ...
            setRowHtArr: function(t, e, n) {
                for (var r, i, o, a, l, s, d, c, u, h, f, p = e, g = this, v = g.jump, m = g.rowhtArr, w = g.data, x = g.colModel, y = g._m(), C = g.diffV, I = g.freezeCols, b = g.rowHt, _ = g.iMerge, q = g.rowHtDetail, R = g.initH, D = g.finalH; p >= t; p--)
                    if (l = w[p], l && !l.pq_hidden && !l.pq_gtitle && !l.pq_gsummary) {
                        for (f = q ? g.getHtDetail(l, q) : 0, c = n ? m[p] - f : b, r = 0; D >= r; r++)
                            if (i = r, r = v(R, I, r), !x[r].hidden) {
                                if (u = y && _.ismergedCell(p, r)) {
                                    if (1 == u || C) continue;
                                    u = _.getRootCell(p, r), s = g.getCell(u.o_ri, u.o_ci)
