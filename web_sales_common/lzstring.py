...
class LZString(object):
    ...
    def __init__(self):
        self.keyStr = u"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
    ...
    def compress(self, uncompressed):
        ...
        context_dictSize = 3
        context_numBits = 2
        context_data_string = u''
        context_data_val = 0
        context_data_position = 0

        uncompressed = uncompressed

        for ii in xrange(len(uncompressed)):
    ...
    def decompress(self, compressed):
        ...
        if (compressed is None) or (compressed == u''):
            return u''
    ...
    def decompresFromBase64(self, iinput):
        ...
        iinput = re.sub(ur'[^A-Za-z0-9\+\/\=]', u'', iinput)
